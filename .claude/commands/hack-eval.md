...
1. **Determine Problem Statement:**
   ...
   - If `$ARGUMENTS` is empty, check if `.agents/skills/ai-agent-hackathon-evaluator/SKILL.md` (or `skills/ai-agent-hackathon-evaluator/SKILL.md`) has a configured problem statement.
...
2. **Execute Evaluation:**
   - Read `.agents/skills/ai-agent-hackathon-evaluator/SKILL.md`.
