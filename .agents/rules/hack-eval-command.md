...
1. **Problem Statement Resolution:**
   ...
   - Otherwise, inspect `.agents/skills/ai-agent-hackathon-evaluator/SKILL.md` to see if `[PROBLEM_STATEMENT]` has been set.
   - If not set, halt and ask the user:
     > "Please provide the hackathon problem statement to begin the AI agent evaluation."
2. **Skill Invocation:**
   - Execute the instructions in `.agents/skills/ai-agent-hackathon-evaluator/SKILL.md`.
